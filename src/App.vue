            ...
            <div class="page-header__left">
              <div class="page-header__logo  logo">
                <router-link to="/home" class="logo__link">
                  <img class="logo__img" src="./assets/img/fini_logo.png" alt="fini">
                </router-link>
              </div>
            </div>
            ...
            <div class="page-footer__right">
              <div class="page-footer__columns">
                <div class="page-footer__col">
                  <h4 class="page-footer__col-title">Почтовый Адрес</h4>
                  <ul class="page-footer__navbar">
                    <li class="page-footer__nav-item">
                      <span class="page-footer__nav-link">Офис 1</span>
                    </li>
                    <li class="page-footer__nav-item">
                      <span class="page-footer__nav-link">г.Бишкек</span>
                    </li>
                    <li class="page-footer__nav-item">
                      <span class="page-footer__nav-link">ул.Шевченко 125</span>
                    </li>
                  </ul>
                </div>
                <div class="page-footer__col">
                  <h4 class="page-footer__col-title">ОсОО "Финипэй"</h4>
                  <ul class="page-footer__contacts contacts-list">
                    <li class="contacts-list__item">
                      ...
                      <div class="contacts-list__value">г.Бишкек ул.Ибраимова 24</div>
                    </li>
                    <li class="contacts-list__item">
                      <svg class='contacts-list__icon  icon  icon--sm'>
                        <use xlink:href='#icon__phone'></use>
                      </svg>
                      <div class="contacts-list__value">Телефон: +996508544411</div>
                    </li>
                    <li class="contacts-list__item">
                      <svg class='contacts-list__icon  icon  icon--sm'>
                        <use xlink:href='#icon__at-sign'></use>
                      </svg>
                      <div class="contacts-list__value">info@finipay.kg</div>
                    </li>
                    <li class="contacts-list__item">
                      <svg class='contacts-list__icon  icon  icon--sm'>
                        <use xlink:href='#icon__at-sign'></use>
                      </svg>
                      <div class="contacts-list__value">myfinipay@gmail.com</div>
                    </li>
                  </ul>
                </div>
              </div>
